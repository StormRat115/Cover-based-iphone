...
### Pages verify (BUILD 20260906-105)

1. Open https://stormrat115.github.io/Cover-based-iphone/
2. Confirm the stamp reads **BUILD 20260906-105**.
3. Start a mission. Cover cubes show Minecraft-like textured faces (top + visible sides) from Phone Art skins — not flat brown fills. Concrete, sandbags, crates, and rubble should read as 3D blocks.
