...
import { COVER_ATLAS_SPRITES } from "./coverAtlasData.js?v=20260906-109";
import { preloadWartornAssets } from "./wartornCity.js?v=20260906-109";
import {
  COVER_BLOCK_SIZE,
  E,
  S,
...
allCoverSkinFiles().forEach(function (file) {
  var image = new Image();
  image.src = "./assets/generated/cover/blocks/" + file + "?v=20260906-109";
