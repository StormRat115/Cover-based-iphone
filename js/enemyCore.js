import { isLineBlocked, getHitChance } from "./cover.js?v=20260907-113";
import { weaponCopy } from "./weapons.js?v=20260907-113";
import {
  moveTowardTarget,
  faceThreat,
  coverStillUseful,
  peekPoint,
} from "./combatAI.js?v=20260907-113";
import {
  ENEMY_STATS,
  mitigateDamage,
  combatAccuracy,
  attackDamage,
} from "./combatStats.js?v=20260907-113";
...
import { orderDefense } from "./squadDialog.js?v=20260907-113";
import { assignEnemyCover } from "./enemyCoverAI.js?v=20260907-113";
import { chargerWeapon } from "./chargerEnemy.js?v=20260907-113";
import { tagEnemyStance, seeksCover, applyExposedHold } from "./enemyStance.js?v=20260907-113";
