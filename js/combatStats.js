...
export const ENEMY_STATS = {
  ...
  ripper: { defense: 12, accuracy: 0, damage: 2 },
  shield: { defense: 55, accuracy: 0, damage: 3 },
  medic: { defense: 18, accuracy: 0, damage: 0 },
};
...
export function finalAccuracy(baseChance, weaponAccuracy, characterAccuracy) {
  return Math.max(
    ...
    Math.min(
      98,
      (Number(baseChance) || 0) +
        (Number(weaponAccuracy) || 0) +
        (Number(characterAccuracy) || 0) +
