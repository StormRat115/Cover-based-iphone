import { sampledLineIntersectsRect } from "./geometry.js?v=20260908-126";
const collisionPieces = new WeakMap();
import { drawShapedCover, drawCityAsset } from "./cityAssets.js?v=20260908-126";
import { createCityCoverLayout } from "./cityMap.js?v=20260908-126";
import {
  coverSlotCount,
  slotWorldPoint,
