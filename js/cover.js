import { sampledLineIntersectsRect } from "./geometry.js?v=20260907-120";
const collisionPieces = new WeakMap();
import { drawShapedCover, drawCityAsset } from "./cityAssets.js?v=20260907-120";
import { createCityCoverLayout } from "./cityMap.js?v=20260907-120";
import {
  coverSlotCount,
  slotWorldPoint,
...
import {
  ...
  livingBlocks,
  syncCoverGeometry,
} from "./coverBlocks.js?v=20260907-120";
export {
  resolveSolidMove,
  updateVault,
  planRoute,
...
// Temporary visibility policy: cover remains physically and tactically useful,
// but never hides a unit from target acquisition.
