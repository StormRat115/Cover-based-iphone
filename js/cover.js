...
import { drawShapedCover, drawCityAsset } from "./cityAssets.js?v=20260906-91";
import { createCityCoverLayout } from "./cityMap.js?v=20260906-91";
import {
  coverSlotCount,
  slotWorldPoint,
...
export {
  ...
  firstCoverOnSegment,
  VAULT_DURATION,
} from "./coverCollision.js?v=20260906-91";
