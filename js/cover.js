import { sampledLineIntersectsRect } from "./geometry.js?v=20260906-105";
const collisionPieces = new WeakMap();
import { drawShapedCover, drawCityAsset } from "./cityAssets.js?v=20260906-105";
import { createCityCoverLayout } from "./cityMap.js?v=20260906-105";
import {
  coverSlotCount,
  slotWorldPoint,
