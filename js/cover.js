import { sampledLineIntersectsRect } from "./geometry.js?v=20260908-131";
const collisionPieces = new WeakMap();
import { drawShapedCover, drawCityAsset } from "./cityAssets.js?v=20260908-131";
import { createCityCoverLayout } from "./cityMap.js?v=20260908-131";
import {
  coverSlotCount,
  slotWorldPoint,
...
import {
  ...
  livingBlocks,
  syncCoverGeometry,
} from "./coverBlocks.js?v=20260908-131";
export {
  resolveSolidMove,
  updateVault,
  planRoute,
