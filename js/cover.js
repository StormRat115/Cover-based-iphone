import { sampledLineIntersectsRect } from "./geometry.js?v=20260907-117";
const collisionPieces = new WeakMap();
import { drawShapedCover, drawCityAsset } from "./cityAssets.js?v=20260907-117";
import { createCityCoverLayout } from "./cityMap.js?v=20260907-117";
import {
  coverSlotCount,
  slotWorldPoint,
...
import {
  ...
  livingBlocks,
  syncCoverGeometry,
} from "./coverBlocks.js?v=20260907-117";
export {
  resolveSolidMove,
  updateVault,
  planRoute,
  ...
  firstCoverOnSegment,
  VAULT_DURATION,
} from "./coverCollision.js?v=20260907-117";
