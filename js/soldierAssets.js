...
friendlyAtlasSource.src =
  "./assets/generated/soldier/player-ally-atlas.png?v=20260906-84";
export const soldierSource = new Image();
soldierSource.src =
  "./assets/EE4CA451-8D37-42A3-9F54-ED1930481CF9.png?v=20260906-84";
export const enemySource = new Image();
enemySource.src =
  "./assets/198C101B-E186-4852-A270-3F04D83451ED.png?v=20260906-84";
export const deathSource = new Image();
deathSource.src = "./assets/soldier_death_sheet.png?v=20260906-84";
export const vaultSheetSource = new Image();
vaultSheetSource.src =
  "./assets/generated/soldier/vault-sheet.png?v=20260906-84";
...
const enemyMonsterSources = Object.fromEntries(
  Object.entries(ENEMY_MONSTER_FILES).map(function ([type, file]) {
    ...
    image.src = "./assets/generated/enemies/" + file + "?v=20260906-84";
    return [type, image];
  }),
);
