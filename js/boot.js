...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city] = await Promise.all([
      import("./mainMenu.js?v=20260906-71"),
      import("./soldierAssets.js?v=20260906-71"),
      import("./cityAssets.js?v=20260906-71"),
    ]);
    ...
    const game = await import("./game.js?v=20260906-71");
    setLoad(100, "READY");
