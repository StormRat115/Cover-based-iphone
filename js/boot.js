...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city] = await Promise.all([
      import("./mainMenu.js?v=20260905-63"),
      import("./soldierAssets.js?v=20260905-63"),
      import("./cityAssets.js?v=20260905-63"),
    ]);
    ...
    const game = await import("./game.js?v=20260905-63");
    setLoad(100, "READY");
