...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city] = await Promise.all([
      import("./mainMenu.js?v=20260905-65"),
      import("./soldierAssets.js?v=20260905-65"),
      import("./cityAssets.js?v=20260905-65"),
    ]);
    ...
    const game = await import("./game.js?v=20260905-65");
    setLoad(100, "READY");
