...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city, audio, charger] = await Promise.all([
      import("./mainMenu.js?v=20260906-107"),
      import("./soldierAssets.js?v=20260906-107"),
      import("./cityAssets.js?v=20260906-107"),
      import("./audio.js?v=20260906-107"),
      import("./chargerEnemy.js?v=20260906-107"),
    ]);
    ...
    const game = await import("./game.js?v=20260906-107");
    setLoad(100, "READY");
