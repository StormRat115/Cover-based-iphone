...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city, audio, charger] = await Promise.all([
      import("./mainMenu.js?v=20260908-128"),
      import("./soldierAssets.js?v=20260908-128"),
      import("./cityAssets.js?v=20260908-128"),
      import("./audio.js?v=20260908-128"),
      import("./chargerEnemy.js?v=20260908-128"),
    ]);
    ...
    const game = await import("./game.js?v=20260908-128");
    setLoad(100, "READY");
