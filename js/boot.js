...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city, audio, charger] = await Promise.all([
      import("./mainMenu.js?v=20260907-121"),
      import("./soldierAssets.js?v=20260907-121"),
      import("./cityAssets.js?v=20260907-121"),
      import("./audio.js?v=20260907-121"),
      import("./chargerEnemy.js?v=20260907-121"),
    ]);
    ...
    const game = await import("./game.js?v=20260907-121");
    setLoad(100, "READY");
