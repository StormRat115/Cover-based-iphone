...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city, audio, charger] = await Promise.all([
      import("./mainMenu.js?v=20260908-125"),
      import("./soldierAssets.js?v=20260908-125"),
      import("./cityAssets.js?v=20260908-125"),
      import("./audio.js?v=20260908-125"),
      import("./chargerEnemy.js?v=20260908-125"),
    ]);
    ...
    const game = await import("./game.js?v=20260908-125");
    setLoad(100, "READY");
