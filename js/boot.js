...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city] = await Promise.all([
      import("./mainMenu.js?v=20260905-64"),
      import("./soldierAssets.js?v=20260905-64"),
      import("./cityAssets.js?v=20260905-64"),
    ]);
    ...
    const game = await import("./game.js?v=20260905-64");
    setLoad(100, "READY");
