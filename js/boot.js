...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city, audio, charger] = await Promise.all([
      import("./mainMenu.js?v=20260908-129"),
      import("./soldierAssets.js?v=20260908-129"),
      import("./cityAssets.js?v=20260908-129"),
      import("./audio.js?v=20260908-129"),
      import("./chargerEnemy.js?v=20260908-129"),
    ]);
    ...
    const game = await import("./game.js?v=20260908-129");
    setLoad(100, "READY");
