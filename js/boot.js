...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city] = await Promise.all([
      import("./mainMenu.js?v=20260905-68"),
      import("./soldierAssets.js?v=20260905-68"),
      import("./cityAssets.js?v=20260905-68"),
    ]);
    ...
    const game = await import("./game.js?v=20260905-68");
    setLoad(100, "READY");
