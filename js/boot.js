...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city, audio, charger] = await Promise.all([
      import("./mainMenu.js?v=20260907-120"),
      import("./soldierAssets.js?v=20260907-120"),
      import("./cityAssets.js?v=20260907-120"),
      import("./audio.js?v=20260907-120"),
      import("./chargerEnemy.js?v=20260907-120"),
    ]);
    ...
    const game = await import("./game.js?v=20260907-120");
    setLoad(100, "READY");
