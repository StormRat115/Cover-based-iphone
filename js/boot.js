...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city, audio] = await Promise.all([
      import("./mainMenu.js?v=20260906-74"),
      import("./soldierAssets.js?v=20260906-74"),
      import("./cityAssets.js?v=20260906-74"),
      import("./audio.js?v=20260906-74"),
    ]);
    ...
    const game = await import("./game.js?v=20260906-74");
    setLoad(100, "READY");
