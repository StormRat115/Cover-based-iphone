...
async function boot() {
  ...
  try {
    ...
    const [menu, soldiers, city, audio, charger] = await Promise.all([
      import("./mainMenu.js?v=20260906-97"),
      import("./soldierAssets.js?v=20260906-97"),
      import("./cityAssets.js?v=20260906-97"),
      import("./audio.js?v=20260906-97"),
      import("./chargerEnemy.js?v=20260906-97"),
    ]);
    ...
    const game = await import("./game.js?v=20260906-97");
    setLoad(100, "READY");
