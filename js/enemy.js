...
function enemySay(e,key,chance){if(e.calloutTimer>0||Math.random()>chance)return;e.callout=pick(ENEMY_LINES[key]);e.calloutTimer=1.15+Math.random()*.55}
