import { getHitChance } from "./cover.js?v=20260907-113";
import {
  resolveSolidMove,
  updateVault,
  planRoute,
  continueRoute,
} from "./coverCollision.js?v=20260907-113";
import { composeSolidAndUnitMove } from "./unitCollision.js?v=20260907-113";
...
import { drawCoverShield } from "./coverSlots.js?v=20260907-113";
import {
  CHARACTER_STATS,
  mitigateDamage,
  combatAccuracy,
...
import { updateDownedCrawl } from "./downedCrawl.js?v=20260907-113";
import {
  tickSuppression,
  suppressionAccuracyDelta,
  isHardSuppressed,
} from "./suppression.js?v=20260907-113";
import { orderAccuracy, orderDefense } from "./squadDialog.js?v=20260907-113";
let shotHud = null,
  weaponHud = null,
  shotFeedbackTime = 0,
  lastWeaponHtml = "";
